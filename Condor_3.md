...
1. Create a new text file named `Condor_3.sh` in your home directory with the following content:
    ...
    flatpak run de.bwravencl.ControllerBuddy -autostart local -profile /app/share/ControllerBuddy-Profiles/Condor_3.json -tray &
    ...
    then
        ...
        "$HOME/.local/share/Steam/ubuntu12_32/steam-launch-wrapper" -- \
            ...
            "$HOME/.local/share/Steam/steamapps/compatdata/$SteamAppId/pfx/drive_c/Condor3/Condor.exe"
    fi
