...
3. Copy the `EF2000 V2.0 for 3DFX` installation folder from step 1 into the newly created folder from step 2, so that it has the following path: `$HOME/EF2000_V2.0/EF2000 V2.0 for 3DFX`
