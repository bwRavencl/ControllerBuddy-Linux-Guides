...
1. Launch **Korea. IL-2 Series** so that the Proton prefix gets created.
...
1. Configure Korea. IL-2 Series to work with the [ControllerBuddy-Profiles](https://github.com/bwRavencl/ControllerBuddy-Profiles):
