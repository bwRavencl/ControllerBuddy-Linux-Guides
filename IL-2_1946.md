...
4. Make sure all your game controllers are connected.

5. Export the `APP_ID` environment variable:
    ```sh
    export APP_ID=15320
    ```
...
7. Install [PowerShell 7+](https://github.com/PowerShell/PowerShell) into the Proton prefix:
    ```sh
...
2. Execute the following command (steps 5, 9, and 10 combined):
