...
1. Launch and immediately exit **IL-2 Sturmovik: 1946** so that the Proton prefix and the registry entries of IL-2 Sturmovik: 1946 get created.
...
1. Configure IL-2 Sturmovik: 1946 to work with the [ControllerBuddy-Profiles](https://github.com/bwRavencl/ControllerBuddy-Profiles):
...
1. Add the `IL-2_1946.sh` launch script as a Non-Steam game to your Steam library.

1. Rename the **IL-2_1946.sh** Steam shortcut to **IL-2 Sturmovik: 1946 (Gaming Mode)**.
...
1. Apply the layout to both **IL-2 Sturmovik: 1946** shortcuts in your Steam library.
